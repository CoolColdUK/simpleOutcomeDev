...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "SimpleOutcome - Innovative Digital Solutions & Portfolio",
    description:
      "Professional portfolio showcasing innovative digital solutions including CraftySmile and GoalJar.",
    images: ["/og-image.jpg"],
    creator: "@simpleoutcome",
  },
  robots: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: [
                "https://twitter.com/simpleoutcome",
                "https://linkedin.com/company/simpleoutcome",
              ],
              contactPoint: {
                "@type": "ContactPoint",
